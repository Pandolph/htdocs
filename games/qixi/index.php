...
<meta content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no" name="viewport">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/start_page.jpg?2">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/game_bg.jpg?1">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/score_bg.png?3">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/lovers_0.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/lovers_1.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/lovers_2.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/lovers_3.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/blood.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/single_0.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/single_1.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/single_2.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/single_3.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/time_over.png">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/share.png?2">
	<link rel="prerender" href="http://g.huceo.com/weixin/ssql/img/music.mp3">
    ...
    #welcome {background:url(http://g.huceo.com/weixin/ssql/img/start_page.jpg?2) no-repeat;overflow: hidden;background-size: 100% 100%;}
    .welcome-bg {position:absolute;top:0;left:0;right:0;bottom:0;}
	#GameLayerBG {top:0;left:0;right:0;bottom:0;overflow:hidden;background:url(http://g.huceo.com/weixin/ssql/img/game_bg.jpg?1) no-repeat;background-size:100% 100%;}
    ...
    .t0{background-image:url(http://g.huceo.com/weixin/ssql/img/lovers_0.png);}
    .t1{background-image:url(http://g.huceo.com/weixin/ssql/img/lovers_1.png);}
    .t2{background-image:url(http://g.huceo.com/weixin/ssql/img/lovers_2.png);}
    .t3{background-image:url(http://g.huceo.com/weixin/ssql/img/lovers_3.png);}
    .tt0{ background-image:url(http://g.huceo.com/weixin/ssql/img/blood.png);background-size:100% auto;}
    .s0{background-image:url(http://g.huceo.com/weixin/ssql/img/single_0.png);}
    .s1{background-image:url(http://g.huceo.com/weixin/ssql/img/single_1.png);}
    .s2{background-image:url(http://g.huceo.com/weixin/ssql/img/single_2.png);}
    .s3{background-image:url(http://g.huceo.com/weixin/ssql/img/single_3.png);}
    @-ms-keyframes flash {
    	0% { opacity: 1; }
    	50% { opacity: 0; }
    	100% { opacity: 1; }
    ...
    .bad {-webkit-animation: flash .2s 3;animation: flash .2s 3;background-image:url(http://g.huceo.com/weixin/ssql/img/blood.png);background-size:100% auto;}
    *    {-webkit-tap-highlight-color: rgba(0,0,0,0);-ms-tap-highlight-color: rgba(0,0,0,0); tap-highlight-color: rgba(0,0,0,0); -ms-user-select: none;}
    #GameScoreLayer {background-position:center .5em; background-size: auto 4em; font-weight: bold; color:#fff; text-align: center;overflow: hidden;background:url(http://g.huceo.com/weixin/ssql/img/score_bg.png?3) no-repeat #191a1e;background-size:100% 100%;}
	...
	#timeOver{width:0%;position: absolute;height:17.5%;left:0%;top:16%;display:none;background:url(http://g.huceo.com/weixin/ssql/img/time_over.png) no-repeat;background-size: 100% 100%}
    </style>
</head>
<body onLoad="init()">
	...
	//分享
	window.shareData = {
        "imgUrl": "http://g.huceo.com/weixin/ssql/img/fx.jpg",
        "timeLineLink": "http://g.huceo.com/weixin/ssql",
	...
	function gameInit(){
        createjs.Sound.registerSound( {src:"http://g.huceo.com/weixin/ssql/img/music.mp3", id:"tap"} );
		gameRestart();
	}
	...
	function more(){
		document.location.href = "http://g.huceo.com/weixin/game.html";
	}
	...
	<div id='scoreTotal'><img src='http://g.huceo.com/weixin/ssql/img/title_bg.png' id='titleBg'><span id='number'>=&nbsp;<span id='score'>0</span></span><img src='http://g.huceo.com/weixin/ssql/img/photo_bg.png' id='photo'><div id="GameTimeLayer"></div></div>
	<div id="welcome" class="SHADE BOX-M">
		<div class="welcome-bg FILL"></div>
		<div id="ready-btn" class="btn loading">加载中...</div>	
	</div>
	<div id='timeOver'></div>
	<div id="share-wx"><img src="http://g.huceo.com/weixin/ssql/img/share.png?2" id="share-wx-img"></div>
<script type="text/javascript">
	if (isDesktop)
		document.write('</div>');
</script>
