...
shareData = {
    imgUrl: "http://g.huceo.com/weixin/zhaonimei/zhaonimei.jpg",
    timeLineLink: "http://g.huceo.com/weixin/zhaonimei/index.html",
...
function(a) {
    ...
    f = {
        init: function() {
            this.initEvent(),
            this.loading(),
            /android/i.test(c) ? (b.banner.attr("href", "http://g.huceo.com/").data("type", "android").find("img").attr("src", "assets/img/banner.android.jpg"), b.banner.show()) : /iphone|ipad|ipod/i.test(c) && (b.banner.attr("href", "http://g.huceo.com/").data("type", "ios").find("img").attr("src", "assets/img/banner.ios.jpg"), b.banner.show())
        },
        loading: function() {
            function a() {
                d++,
