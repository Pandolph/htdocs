var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        self.wxData = {
            "appId": "", // 服务号可以填写appId
            "imgUrl" : 'http://g.huceo.com/weixin/diaoyu/logo.png',
            "link" : 'http://g.huceo.com/weixin/diaoyu/',
        ...
        WeixinApi.ready(function(Api) {
            ...
            var wxCallbacks = {
                ...
                confirm : function(resp) {
                    ...
                    //window.location.href='http://g.huceo.com/';
                    // alert("分享成功");
                },
                // 整个分享过程结束
                all : function(resp) {
                    ...
                    // alert("分享结束");
                    if(self.isGameOver){
                        if(window.location) window.location.href = "http://g.huceo.com/weixin/diaoyu/";
                    }
                }
            };
    ...
    gameOver: function(){
        ...
        layerMask.delay(0.5).then(function(){
            ...
            var share = cc.createSprite('http://g.huceo.com/weixin/diaoyu/share.png', {
                anchor: [1.0, 1.0],
                xy: [720, 1280],
                opacity: 0,
                scale: 0.5
